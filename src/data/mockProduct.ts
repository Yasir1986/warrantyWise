...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Slim, RFID-blocking genuine leather wallet with quick-access card slots.',
    price: 45.00,
  ...
  },
  {
    ...
    description: 'Ultra-soft, sustainably sourced organic cotton t-shirt for everyday wear.',
    price: 25.00,
    category: 'Clothing',
  ...
  },
  {
    ...
    description: 'Double-wall vacuum insulated bottle keeps drinks cold for 24 hours or hot for 12.',
    price: 35.00,
  ...
  },
  {
    ...
    description: 'Tenkeyless mechanical keyboard with tactile switches and customizable RGB lighting.',
    price: 120.00,
    category: 'Electronics',
  ...
  },
  {
    ...
    description: 'Durable canvas backpack with laptop sleeve and multiple compartments for travel.',
    price: 65.00,
    category: 'Accessories',
